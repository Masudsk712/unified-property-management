import { Activity, Amenity, Booking, DashboardStats, MaintenanceRequest, Notification, Property, User } from "@/types";
...
export const maintenanceRequests: MaintenanceRequest[] = [
  {
    ...
    description: "The kitchen faucet has been dripping constantly for the past 3 days. Water is pooling underneath the sink.",
    category: "plumbing",
    priority: "medium",
    status: "open",
  ...
  },
  {
    ...
    description: "The air conditioning unit is blowing warm air. Temperature inside unit is 82°F despite thermostat set to 72°F.",
    category: "hvac",
    priority: "high",
    status: "in-progress",
  ...
  },
  {
    ...
    description: "Elevator #3 in the east wing has stopped working. Residents are reporting being stuck for 10 minutes.",
    category: "electrical",
    priority: "emergency",
    status: "in-progress",
  ...
  },
  {
    ...
    description: "The large window near the main entrance has a visible crack. Needs assessment and replacement.",
    category: "structural",
    priority: "medium",
    status: "open",
  ...
  },
  {
    ...
    description: "Dishwasher fills with water but doesn't drain. Water remains at bottom after cycle completes.",
    category: "appliance",
    priority: "low",
    status: "resolved",
    ...
    resolvedAt: "2025-05-17T14:30:00Z",
  },
  {
    id: "maint_6",
    propertyId: "prop_6",
    propertyName: "The Commerce Center",
    unit: "Suite 300",
    title: "Pest infestation in break room",
    description: "Multiple reports of cockroaches in the 3rd floor break room. Needs immediate treatment.",
    category: "pest",
    priority: "high",
    status: "in-progress",
  ...
  },
  {
    ...
    description: "Water heater is 12 years old and rusting. Needs complete replacement with new energy-efficient unit.",
    category: "plumbing",
    priority: "medium",
    status: "closed",
...
export const bookings: Booking[] = [
  {
    ...
    propertyName: "Harbor View Complex",
    amenityId: "am_3",
    amenityName: "Clubhouse & Event Space",
    userId: "usr_5",
...
export const notifications: Notification[] = [
  ...
  },
  {
    ...
    message: "Monthly rent payment of $2,800 received for Skyline Towers unit 12A.",
    type: "success",
    read: true,
...
export const activities: Activity[] = [
  ...
  },
  {
    ...
    action: "booked",
    target: "Rooftop Terrace - Corporate Event",
    type: "booking",
  ...
  },
  {
    ...
    target: "Harbor View Complex - Water Heater",
    type: "maintenance",
